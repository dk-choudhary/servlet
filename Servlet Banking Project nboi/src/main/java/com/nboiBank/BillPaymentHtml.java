...
public class BillPaymentHtml extends HttpServlet{
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	     ...
	     pw.println("<!DOCTYPE html>\r\n"
				...
				+ "      <li><a href=\"billpayment\">Bill Payment</a></li>\r\n" 	+ "        </ul>\r\n"
	     		...
	     		+ "        <h2>Bill Payment</h2>\r\n"
	     		+ "        <form action=\"billpaymentaction\" method=\"post\">\r\n"
	     		+ "            <label for=\"to_account\">Pay Bill Type:</label>\r\n"
	     		+ "            <input type=\"text\" id=\"to_account\" name=\"bill\" placeholder=\"Enter Bill Type\" required>\r\n"
