...
public class customerPersonalDetails extends HttpServlet {
    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement(
                    "select * from customer_basic_deatils b inner join customer_address a on b.ac_number=a.ac_number where b.pan_card=? and b.stutas=? and b.name=?");
            ...
            pw.println("<form action='updatePersonalDetails'>");
            ...
            pw.println("<div class=\"details\"><label for=\"father_name\">Father's Name:</label><input type=\"text\" id=\"father_name\" name=\"father_name\" value='" + rs.getString("father_name") + "'></div>");
            pw.println("<div class=\"details\"><label for=\"mother_name\">Mother's Name:</label><input type=\"text\" id=\"mother_name\" name=\"mother_name\" value='" + rs.getString("mother_name") + "'></div>");
            ...
            pw.println("<div class=\"details\"><label for=\"email\">Email:</label><input type=\"email\" id=\"email\" name=\"email\" value='" + rs.getString("email") + "'></div>");
            pw.println("<div class=\"details\"><label for=\"mobile\">Mobile:</label><input type=\"tel\" id=\"mobile\" name=\"mobile\" value='" + rs.getString("mobile") + "' pattern=\"[0-9]{10}\"></div>");
            ...
            pw.println("<div class=\"details\"><label for=\"address\">Persent Address:</label><textarea id=\"address\" name=\"address\" rows=\"4\">" + rs.getString("Persent_address") + "</textarea></div>");
            pw.println("<button class=\"btn\" type=\"submit\" onclick=\"update()\">Save & Go Back</button>");
            pw.println("</div>");
            pw.println("</form>");
            pw.println(" <script>\r\n"
					+ "        function update() {\r\n"
